'''
Tournament-Ready Adaptive PokerBot
Optimized for IITM Pokerbot Competition

Features:
- Preflop equity lookup
- Opponent modeling
- Pot odds decision making
- Auction EV-based bidding
- Bankroll-aware risk management
- Position-aware play
- Fully compliant with engine rules
'''
...
class Player(BaseBot):
    ...
    def on_hand_end(self, game_info: GameInfo, current_state: PokerState):
        ...
        if current_state.opp_revealed_cards:
            # Opponent reached showdown → less likely to fold
            pass
    ...
    def auction_strategy(self, game_info, current_state):
        ...
        bid = int(current_state.pot * bid_fraction)
    ...
    def preflop_strategy(self, game_info, current_state):
        ...
        # Adjust threshold if tight mode
        if self.tight_mode:
    ...
    def postflop_strategy(self, game_info, current_state):
        ...
        # If we saw opponent card from auction
        if current_state.opp_revealed_cards:
